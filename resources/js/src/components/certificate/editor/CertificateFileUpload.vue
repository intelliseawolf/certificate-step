<template>
    <vs-row>
        <vs-col vs-type="flex" vs-justify="center" vs-align="center" vs-w="12">
            ...
            <div
                class="vs-component con-vs-popup vs-popup-primary cstm-modal-popup"
                v-if="uploadmodal"
