<template>
  <div class="upload-image-modal">
    <vs-prompt @close="close" @accept="acceptAlert" buttonAccept="false" buttonCancel="false"
      :active.sync="activePrompt" title="">
      <h3 class="text-center mb-4">Image Upload</h3>
      <div class="con-exemple-prompt">
        <certificate-file-upload class="editor-image-upload" :file_repository_id="4103"
          section_type="CertificateComponent" @image="setImagePath" />
        <!-- <div class="flex mt-3">
